...
#import "JSGuidePageVC.h"
#import "JSGuidePageCollectionViewCell.h"

static NSString * const reuseIdentifier = @"CellIdentfifier";

@interface JSGuidePageVC ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
#pragma mark -- 重新赋值
- (instancetype)initWithNSArray:(NSMutableArray *)array withButton:(JSGuideExButton *)startButton withButtonHeight:(CGFloat)startHeight withViewController:(UIViewController *)controller
{
    if (self = [super init]) {
        self.mArray = array;
...
- (instancetype)initWithNSArray:(NSMutableArray *)array withButton:(JSGuideExButton *)startButton
{
    if (self = [super init]) {
        self.mArray = array;
    }
...
- (void)initilizationSub
{
    ...
    //注册cell
    [self.collectionView registerClass:[JSGuidePageCollectionViewCell class] forCellWithReuseIdentifier:reuseIdentifier];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //3.如果没有注册，就注册
    JSGuidePageCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:reuseIdentifier forIndexPath:indexPath];
    ...
    cell.startButton.buttonTitleLable.text = self.buttonTitle;
    cell.startButton.buttonTitleLable.textColor = self.titleColor;
